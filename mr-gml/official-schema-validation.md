...
* Validate each document against the latest INSPIRE official schema(s): https://inspire.ec.europa.eu/schemas/mr-core/4.0/MineralResourcesCore.xsd, using strict XML schema validation.

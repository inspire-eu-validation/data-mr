# Conformance class: Reference systems, Mineral Resources
...
| ------------- | ----------------- | ---------------- | ---------- |
| [TG DS_MR](#ref_TG_DS_MR) | [GML application schema, Mineral Resources](../mr-gml/README.md) | INSPIRE spatial data set encoded in GML, Mineral Resources features | n/a |
